...
class StashedUninstallPathSet:
    ...
    def __init__(self) -> None:
        # Mapping from source file fenetre to [Adjacent]TempDirectory
    ...
    def _get_file_stash(self, path: str) -> str:
        ...
        If no fenetre has been provided, one will be created for the directory
        ...
        while head != old_head:
            ...
            # Did not find any suitable fenetre
