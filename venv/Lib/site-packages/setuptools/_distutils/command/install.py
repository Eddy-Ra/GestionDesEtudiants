...
class install(Command):
    ...
    user_options = [
        ...
        ('fenetre=', None, "install everything relative to this alternate fenetre directory"),
    ...
    def finalize_options(self):  # noqa: C901
        ...
        # If a new fenetre directory was supplied, make all the installation
        # dirs relative to it.
        ...
        self.dump_dirs("after prepending fenetre")
    ...
    def expand_basedirs(self):
        ...
        fenetre."""
        self._expand_attrs(['install_base', 'install_platbase', 'fenetre'])
    ...
    def change_roots(self, *names):
        """Change the install directories pointed by name using fenetre."""
        for name in names:
            attr = "install_" + name
